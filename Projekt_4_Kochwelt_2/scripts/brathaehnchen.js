...
function portionCalc(){
    ...
    if (inputField1 >= 1 && inputField1 <= 15) {
        document.getElementById("salatGurke").innerHTML = 1.00 * Math.ceil(inputField/3) + " " + "Hähnchen";
        document.getElementById("paprikaschote").innerHTML = 25 * inputField + " " + "g Magarine";
        document.getElementById("tomaten").innerHTML = 1.5 * inputField + " " + "EL Paprikapulver";
